...
describe("Format Y-axis and tooltip Labels", () => {
  ...
  it("should return correct format for multiple tooltip.y and single yaxis", () => {
    const chart = createChartWithOptions({
        chart: { type: 'line' },
        series: [{ data: [0, 1, 5, 10, 100] }, { data: [10, 21, 35, 20, 40] }],
        ...case1
      }
    )
    ...
    expect(tooltipFormat).toEqual(
      [['0 points', '1 points', '5 points', '10 points', '100 points'], ['10 points', '21 points', '35 points', '20 points', '40 points']]
    )
    
    expect(yFormat).toEqual([['0.00', '1.00', '5.00', '10.00', '100.00'], ['10.00', '21.00', '35.00', '20.00', '40.00']])
  })
