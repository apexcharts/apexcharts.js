...
var require_builtin_npmrc = __commonJS({
  "libs/commands/create/src/lib/builtin-npmrc.ts"(exports2, module2) {
    ...
    module2.exports.builtinNpmrc = builtinNpmrc2;
    function builtinNpmrc2() {
      let resolvedPath = "";
      try {
        resolvedPath = import_path.default.resolve(
          import_fs_extra.default.realpathSync(import_path.default.join(import_path.default.dirname(process.execPath), "npm")),
          "../../npmrc"
        );
      } catch (err) {
      }
