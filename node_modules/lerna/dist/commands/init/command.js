...
var import_os2, import_path5, import_write_file_atomic;
...
function npmInstall(pkg, { registry, npmClient, npmClientArgs, npmGlobalStyle, mutex, stdio = "pipe", subCommand = "install" }) {
  ...
  npmlog_default.silly("npmInstall", [cmd2, args]);
  return childProcess8.exec(cmd2, args, opts);
}
...
var import_devkit5, import_fs5, import_fs_extra8, import_tree, LARGE_BUFFER, childProcess11, PACKAGE_GLOB, InitCommand;
var init_src3 = __esm({
  "libs/commands/init/src/index.ts"() {
    "use strict";
    init_src2();
    ...
    import_fs_extra8 = require("fs-extra");
      ...
      async execute() {
        ...
        changes.forEach((f) => {
          if (f.type === "CREATE") {
            ...
            if (isDryRun) {
              const currentContentsOnDisk = (0, import_fs_extra8.readFileSync)((0, import_devkit5.joinPathFragments)(tree.root, f.path)).toString();
...
`);
        ...
        return async () => {
          if (isGitInitialized(this.cwd)) {
            ...
            await childProcess11.exec("git", ["init"], {
              cwd: this.cwd,
              maxBuffer: 1024
            });
          }
          if (this.args.skipInstall === void 0) {
            ...
            await childProcess11.exec(command, args, {
              cwd: this.cwd,
      ...
      detectPackageManager() {
        const packageManager = (0, import_fs5.existsSync)("yarn.lock") ? "yarn" : (0, import_fs5.existsSync)("pnpm-lock.yaml") ? "pnpm" : (0, import_fs5.existsSync)("package-lock.json") ? "npm" : null;
        if (packageManager) {
...
var import_command2 = __toESM(require_command());
module.exports = import_command2.default;
