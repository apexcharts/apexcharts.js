...
function resolvePrettier() {
  if (!resolvedPrettier) {
    try {
      const packageJson = (0, import_devkit5.readJsonFile)(import_path9.default.join(import_devkit5.workspaceRoot, "package.json"));
...
async function maybeFormatFile(filePath) {
  ...
  const ignorePath = import_path9.default.join(import_devkit5.workspaceRoot, ".prettierignore");
  const fullFilePath = import_path9.default.join(import_devkit5.workspaceRoot, filePath);
...
async function gitAdd(changedFiles, gitOpts, execOpts) {
  ...
  for (const file of changedFiles) {
    const filePath = (0, import_slash2.default)(import_path9.default.relative(execOpts.cwd, import_path9.default.resolve(execOpts.cwd, file)));
...
var import_devkit5, import_fs5, import_path9, import_slash2, childProcess11, resolvedPrettier;
