...
async function updateLockfileVersion(pkg) {
  const lockfilePath = import_path9.default.join(pkg.location, "package-lock.json");
  ...
  (0, import_devkit5.writeJsonFile)(lockfilePath, obj, {
    spaces: 2
  });
  return lockfilePath;
}
var import_devkit5, import_load_json_file3, import_path9;
