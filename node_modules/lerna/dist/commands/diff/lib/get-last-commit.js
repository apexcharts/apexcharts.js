...
var get_last_commit_exports = {};
__export(get_last_commit_exports, {
  getLastCommit: () => getLastCommit
});
module.exports = __toCommonJS(get_last_commit_exports);
...
var tempfile = (filePath) => import_path8.default.join(import_temp_dir.default, uuid.v4(), filePath || "");
