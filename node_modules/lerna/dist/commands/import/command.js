...
var import_dedent5, import_fs_extra8, import_p_map_series, import_path12, childProcess11, ImportCommand;
var init_src3 = __esm({
  "libs/commands/import/src/index.ts"() {
    "use strict";
    init_src2();
    ...
    ImportCommand = class extends Command {
      ...
      execSync(cmd2, args) {
        return childProcess11.execSync(cmd2, args, this.execOpts);
      }
      externalExecSync(cmd2, args) {
        return childProcess11.execSync(cmd2, args, this.externalExecOpts);
      }
