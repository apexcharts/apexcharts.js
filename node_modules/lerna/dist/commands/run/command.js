...
function npmRunScriptStreaming(script, { args, npmClient, pkg, prefix, reject = true }) {
  ...
  const argv = ["run", script, ...args];
  const opts = makeOpts(pkg, reject);
  return childProcess9.spawnStreaming(npmClient, argv, opts, prefix && pkg.name);
}
...
var import_fs_extra8, import_run_many, import_run_one, import_p_map3, import_path13, import_perf_hooks, RunCommand;
var init_src3 = __esm({
  "libs/commands/run/src/index.ts"() {
    "use strict";
    init_src2();
