...
function formatColumns(resultList, viewOptions) {
  const formattedResults = resultList.map((project) => {
    ...
    if (pkg.version) {
      formatted.version = import_chalk3.default.green(`v${pkg.version}`);
    } else {
    ...
    formatted.location = import_chalk3.default.grey(import_path9.default.relative(".", pkg.location));
    return formatted;
  });
  return trimmedColumns(formattedResults, viewOptions);
}
var import_chalk3, import_columnify, import_path9;
