...
(function (global, factory) {
  ...
  function () {
    ...
    _createClass(Helpers, [{
      ...
      value: function getStringX(x) {
        var w = this.w;
        var rX = x;
        var coreUtils = new CoreUtils(this.annoCtx.ctx); // w.globals.labels is changed at this point for xaxis.convertedCatToNumeric, hence passing is as param instead of directly getting in the getCategoryLabels function

        var labels = coreUtils.getCategoryLabels(w.globals.labels);
        var catIndex = labels.indexOf(x);
      ...
      value: function addYaxisAnnotation(anno, parent, index) {
        ...
        if (anno.y2 === null) {
          ...
          if (this.annoCtx.invertAxis) {
            ...
            if (w.config.xaxis.convertedCatToNumeric) {
              _catIndex = w.globals.categoryLabels.indexOf(anno.y2);
            }
  ...
  var optionXAxisAnnotation = _objectSpread2({
    x: 0,
    x2: null
  }, annotationLine, {
    label: {
      ...
      offsetX: 0,
      offsetY: 0,
      style: _objectSpread2({}, annoStyle)
    }
  });
  var optionYAxisAnnotation = _objectSpread2({
    y: 0,
    y2: null
  }, annotationLine, {
    yAxisIndex: 0,
  ...
  function () {
    ...
    _createClass(Annotations, [{
      ...
      value: function addAnnotationExternal(_ref) {
        ...
        var axesAnno = Object.assign({}, type === 'xaxis' ? optionXAxisAnnotation : type === 'yaxis' ? optionYAxisAnnotation : optionPointAnnotation);
  ...
  function () {
    ...
    _createClass(AxesUtils, [{
      ...
      key: "checkForCroppedLabels",
      value: function checkForCroppedLabels(i, label, labelsLen) {
        var w = this.w;

        if (i === 0) {
          // check if first label is being cropped
          if (w.globals.skipFirstTimelinelabel && !w.config.xaxis.convertedCatToNumeric) {
            label.text = '';
          }
        }
        ...
        if (i === labelsLen - 1) {
          ...
          if (w.globals.skipLastTimelinelabel && !w.config.xaxis.convertedCatToNumeric) {
            label.text = '';
          }
        }
      ...
      value: function drawXaxis() {
        ...
        if (w.config.xaxis.labels.show) {
          var _loop = function _loop(_i) {
            ...
            var label = _this.axesUtils.getLabel(labels, w.globals.timescaleLabels, x, _i, _this.drawnLabels);
            ...
            label = _this.axesUtils.checkForCroppedLabels(_i, label, labelsLen);
        ...
        if (w.config.xaxis.labels.show) {
          for (var i = tl ? 0 : tickAmount; tl ? i < tl : i >= 0; tl ? i++ : i--) {
            ...
            if (timescaleLabels.length) {
              var label = this.axesUtils.getLabel(labels, timescaleLabels, x, i, this.drawnLabels);
              x = label.x;
              val = label.text;
  ...
  function () {
    ...
    _createClass(Config, [{
        ...
        if (isLogY && opts.series.length !== opts.yaxis.length) {
          opts.yaxis = opts.series.map(function (s, i) {
            ...
            if (opts.yaxis[i]) {
              ...
              var newYaxis = Utils.extend(optionYAxis, opts.yaxis[0]);
              newYaxis.show = false;
              return newYaxis;
            }
          });
      ...
      value: function extendYAxisAnnotations(opts) {
        opts.annotations.yaxis = Utils.extendArray(typeof opts.annotations.yaxis !== 'undefined' ? opts.annotations.yaxis : [], optionYAxisAnnotation);
        return opts;
      }
    }, {
      key: "extendXAxisAnnotations",
      value: function extendXAxisAnnotations(opts) {
        opts.annotations.xaxis = Utils.extendArray(typeof opts.annotations.xaxis !== 'undefined' ? opts.annotations.xaxis : [], optionXAxisAnnotation);
        return opts;
      }
    }, {
      key: "extendPointAnnotations",
      value: function extendPointAnnotations(opts) {
        opts.annotations.points = Utils.extendArray(typeof opts.annotations.points !== 'undefined' ? opts.annotations.points : [], optionPointAnnotation);
        return opts;
      }
    }, {
    ...
    _createClass(DimXAxis, [{
      ...
      value: function getxAxisLabelsCoords() {
        ...
        if (w.globals.timescaleLabels.length > 0) {
          ...
          if (rect.width * xaxisLabels.length > w.globals.svgWidth - this.dCtx.lgWidthForSideLegends - this.dCtx.yAxisWidth - this.dCtx.gridPad.left - this.dCtx.gridPad.right && w.config.xaxis.labels.rotate !== 0) {
            if (!w.globals.isBarHorizontal) {
      ...
      value: function additionalPaddingXLabels(xaxisLabelCoords) {
        ...
        var predictedGridWidth = gl.svgWidth - this.dCtx.lgWidthForSideLegends - this.dCtx.yAxisWidth - this.dCtx.gridPad.left - this.dCtx.gridPad.right;
        ...
        var padYAxe = function padYAxe(yaxe, i) {
          ...
          if (xtype !== 'datetime') {
            if (_this.dCtx.gridPad.left < lbWidth / 2 - _this.dCtx.yAxisWidthLeft && !gl.rotateXLabels) {
  ...
  function () {
    ...
    _createClass(Helpers, [{
      ...
      value: function hideSeries(_ref) {
        ...
        this.lgCtx.ctx._updateSeries(w.config.series, w.config.chart.animations.dynamicAnimation.enabled);
      }
    }, {
  ...
  **/
  ...
  function () {
    function ApexCharts(el, opts) {
      ...
      this.eventList = ['click', 'mousedown', 'mousemove', 'touchstart', 'touchmove', 'mouseup', 'touchend'];
      this.initModules();
    ...
    _createClass(ApexCharts, [{
      ...
      value: function getGroupedCharts() {
        ...
        return Apex._chartInstances.filter(function (ch) {
          ...
          return _this3.w.config.chart.group === ch.group ? ch.chart : _this3;
        });
      }
      /**
      ...
      value: function update(options) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this4.mount(graphData).then(function () {
            ...
            _this4.fireEvent('updated', [_this4, _this4.w]);
      ...
      value: function revertDefaultAxisMinMax() {
        ...
        w.config.yaxis.map(function (yaxe, index) {
          if (w.globals.zoomed) {
            ...
            if (typeof _this5.opts.yaxis[index] !== 'undefined') {
              yaxe.min = _this5.opts.yaxis[index].min;
              yaxe.max = _this5.opts.yaxis[index].max;
            }
          }
        });
      }
      ...
      value: function clearDomElements() {
        ...
        this.eventList.forEach(function (event) {
          document.removeEventListener(event, _this6.documentEvent);
        });
      ...
      value: function toggleSeries(seriesName) {
        ...
        this.legend.legendHelpers.toggleDataSeries(isSeriesHidden.realIndex, isSeriesHidden.isHidden);
      ...
      value: function hideSeries(seriesName) {
        ...
        if (!isSeriesHidden.isHidden) {
          this.legend.legendHelpers.toggleDataSeries(isSeriesHidden.realIndex, false);
        }
      }
    }, {
      key: "resetSeries",
      ...
      value: function setupEventHandlers() {
        ...
        this.eventList.forEach(function (event) {
          document.addEventListener(event, _this7.documentEvent);
        });
      ...
      value: function windowResize() {
        ...
        this.w.globals.resizeTimer = window.setTimeout(function () {
          _this8.w.globals.resized = true;
          _this8.w.globals.dataChanged = false; // we need to redraw the whole chart on window resize (with a small delay).
      ...
      value: function exec(chartID, fn) {
        ...
        var methodNames = ['updateOptions', 'updateSeries', 'appendData', 'appendSeries', 'toggleSeries', 'showSeries', 'hideSeries', 'setLocale', 'resetSeries', 'toggleDataPointSelection', 'dataURI', 'addXaxisAnnotation', 'addYaxisAnnotation', 'addPointAnnotation', 'addText', 'clearAnnotations', 'removeAnnotation', 'paper', 'destroy'];
        var ret = null;
