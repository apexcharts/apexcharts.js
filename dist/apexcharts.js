...
var Bar = function () {
  ...
  _createClass(Bar, [{
    ...
    value: function calculateDataLabelsPos(_ref5) {
      var x = _ref5.x,
          y = _ref5.y,
          i = _ref5.i,
          j = _ref5.j,
      ...
      if (this.isHorizontal) {
        ...
        dataLabelsPos = this.calculateColumnsDataLabelsPosition({ x: x, y: y, i: i, j: j, bcx: bcx, bcy: bcy, barHeight: barHeight, barWidth: barWidth, textRects: textRects, strokeWidth: strokeWidth, dataLabelsY: dataLabelsY, barDataLabelsConfig: barDataLabelsConfig, offX: offX, offY: offY });
      }
    ...
    value: function drawCalculatedDataLabels(_ref6) {
      var x = _ref6.x,
          y = _ref6.y,
          val = _ref6.val,
          i = _ref6.i,
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this.el !== null) {
          ...
          _this.mount(graphData).then(function () {
            _this.animations.showDelayedElements();
            resolve(graphData);
    ...
    value: function init(_ref) {
      ...
      try {
        for (var _iterator = this.eventList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          this.hoverArea.addEventListener(event, me.svgMouseEvents.bind(me, xyRatios), false);
        }
      } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
    ...
    value: function destroy() {
      ...
      try {
        for (var _iterator2 = this.eventList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (this.hoverArea) {
            this.hoverArea.removeEventListener(event, me.svgMouseEvents.bind(me, me.xyRatios), false);
          }
        }
      } catch (err) {
        _didIteratorError2 = true;
