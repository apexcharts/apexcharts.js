        ...
        [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var M = this.drawPath({ d: e, stroke: o, strokeWidth: l, fill: c, fillOpacity: 1, classes: x, strokeLinecap: h, strokeDashArray: I });
              ...
              return (
                !L || A.globals.resized || A.globals.dataChanged ? (!A.globals.resized && A.globals.dataChanged) || C.showDelayedElements() : C.animatePathsGradually(n({}, X, { speed: g })),
                A.globals.dataChanged && P && T && C.animatePathsGradually(n({}, X, { speed: p })),
                  M
              );
            },
          },
  ...
  S = (function () {
    function t() {
      e(this, t),
        ...
        (this.shape = { x: 0, y: 0, type: "rect", width: "100%", height: 50, appendTo: ".apexcharts-annotations", backgroundColor: "#fff", opacity: 1, borderWidth: 0, borderRadius: 4, borderColor: "#c2c2c2" });
    }
    return (
      a(t, [
        {
          ...
          value: function () {
            return {
              ...
              chart: {
                ...
                stacked: !1,
                stackType: "normal",
                toolbar: { show: !0, offsetX: 0, offsetY: 0, tools: { download: !0, selection: !0, zoom: !0, zoomin: !0, zoomout: !0, pan: !0, reset: !0, customIcons: [] }, autoSelected: "zoom" },
                type: "line",
                width: "100%",
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            s =
              "circle" === i.type
                ? this.graphics.drawCircle(i.circleRadius, { fill: i.backgroundColor, stroke: i.borderColor, "stroke-width": i.borderWidth, opacity: i.opacity, cx: i.x, cy: i.y })
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return p && l.insertBefore(p.node, f), i && o.globals.memory.methodsToExec.push({ context: n, id: u.id ? u.id : g.randomId(), method: r, label: "addAnnotation", params: e }), a;
          },
        },
        {
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            p.setAttrs(h, { id: t.patternID, patternUnits: t.patternUnits ? t.patternUnits : "userSpaceOnUse", width: o + "px", height: l + "px" });
        ...
        },
        {
          ...
          value: function (t) {
            var e = this.w;
            return (
              (("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && e.config.plotOptions.bar.distributed) || "heatmap" === e.config.chart.type
            ...
            if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length)
              a =
                "dark" === s.fill.gradient.shade
                  ? o.shadeColor(-1 * parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? g.rgb2hex(t) : t)
                  : o.shadeColor(parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? g.rgb2hex(t) : t);
            else {
            ...
            if (((n.globals.markers.size[e] > 0 || r) && (h = c.group({ class: r ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")), l.x instanceof Array))
              for (var d = 0; d < l.x.length; d++) {
                ...
                if (b || r) {
                  ...
                  (n.config.series[o].data[i].fillColor && (m.pointFillColor = n.config.series[o].data[i].fillColor),
          ...
          value: function (t, e, i, a, s, r, n) {
            ...
            if (
              (o.config.series[l].data[r] && o.config.series[l].data[r].fillColor && (m = o.config.series[l].data[r].fillColor),
                v.attr({ cx: t, cy: e, fill: m, stroke: b.pointStrokeColor, "stroke-width": b.pWidth, "stroke-dasharray": b.pointStrokeDashArray, "stroke-opacity": b.pointStrokeOpacity }),
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            var z = { x: e, y: i, i: r, j: n, renderedPath: u, bcx: m, bcy: v, barHeight: h, barWidth: c, textRects: P, strokeWidth: b, dataLabelsX: y, dataLabelsY: w, barDataLabelsConfig: S, offX: C, offY: L };
            return (
          ...
          value: function (t) {
            ...
            if (c.enabled && !m) {
              ...
              (this.barCtx.isHorizontal
                ? (((h = Math.abs(d.globals.series[s][r]) / this.barCtx.invertedYRatio[this.barCtx.yaxisIndex]) > 0 && o.width / 1.6 > h) || (h < 0 && o.width / 1.6 < h)) && (v = "")
                : ((l = Math.abs(d.globals.series[s][r]) / this.barCtx.yRatio[this.barCtx.yaxisIndex]), o.height / 1.6 > l && (v = "")));
              var k = n({}, c);
              this.barCtx.isHorizontal && a < 0 && ("start" === c.textAnchor ? (k.textAnchor = "end") : "end" === c.textAnchor && (k.textAnchor = "start")),
                u.plotDataLabelsText({ x: e, y: i, text: v, i: s, j: r, parent: b, dataLabelsConfig: k, alwaysDrawDataLabel: !0, offsetCorrection: !0 });
            }
            return b;
          },
        },
          ...
          value: function () {
            ...
            if ((this.barCtx.isTimelineBar && (h = l.globals.labels.length), this.barCtx.isHorizontal))
              ...
              if (
                ...
                l.globals.minXDiff && 0.5 !== l.globals.minXDiff && l.globals.minXDiff / c > 0 && (a = l.globals.minXDiff / c),
      ...
      a(t, [
          ...
          value: function (t, e) {
            ...
            for (var o = 0, l = 0; o < t.length; o++, l++) {
              ...
              for (var C = a.group({ class: "apexcharts-datalabels", "data:realIndex": y }), L = 0; L < i.globals.dataPoints; L++) {
                ...
                this.isHorizontal
                  ? ((T = this.drawBarPaths(n({}, z, { barHeight: k, zeroW: u, yDivision: c }))), (A = this.series[o][L] / this.invertedYRatio))
                  : ((T = this.drawColumnPaths(n({}, z, { xDivision: h, barWidth: A, zeroH: d }))), (k = this.series[o][L] / this.yRatio[this.yaxisIndex])),
                  (x = T.y),
                  (f = T.x),
                L > 0 && v.push(f + A / 2),
                  b.push(x);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var P = new I(this).handleBarDataLabels({ x: c, y: d, y1: g, y2: f, i: r, j: s, series: x, realIndex: e, barHeight: b, barWidth: m, barYPosition: v, renderedPath: L, visibleSeries: w });
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var f = this.barHelpers.getBarpaths({ barYPosition: u, barHeight: i, x1: s, x2: r, strokeWidth: a, series: this.series, realIndex: e.realIndex, i: c, j: d, w: h });
            return (
              h.globals.isXNumeric || (n += o),
                this.barHelpers.barBackground({ bc: g, i: c, y1: u - i * this.visibleI, y2: i * this.seriesLen, elSeries: l }),
          ...
          value: function (t) {
            ...
            return (
              h.globals.isXNumeric || (i += s),
                this.barHelpers.barBackground({ bc: g, i: c, x1: f - o / 2 - r * this.visibleI, x2: r * this.seriesLen + o / 2, elSeries: l }),
                ...
                for (var y = a.group({ class: "apexcharts-datalabels", "data:realIndex": f }), w = 0; w < i.globals.dataPoints; w++) {
                  ...
                  if (((u = v.yDivision), (b = v.barHeight), this.isHorizontal)) {
                    ...
                    if (this.isTimelineBar && i.config.series[r].data[w].x) {
                      var z = this.detectOverlappingBars({ i: r, j: w, barYPosition: L, srty: T, barHeight: b, yDivision: u, initPositions: v });
      ...
      a(i, [
        {
          ...
          value: function (e) {
            ...
            "histogram" === this.chartType && ((a.chart.type = "bar"), (a = g.extend({ plotOptions: { bar: { columnWidth: "99.99%" } } }, a))),
            ...
            if (a && "object" === t(a)) {
              var l = {};
              (l =
                -1 !== ["line", "area", "bar", "candlestick", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type) ? r[a.chart.type]() : r.line()),
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            return (
              g.isNumber(t) &&
              (t = 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 10 ? t.toFixed(1) : t.toFixed(0)),
                t
            );
          },
        },
                  ...
                  ? (function (t, e) {
                    if ((l.length && 0 === e && h.push(l.join(s)), t.data && t.data.length))
                      for (var a = 0; a < t.data.length; a++) {
                        ...
                        (l.pop(), l.push(o.globals.seriesCandleO[e][a]), l.push(o.globals.seriesCandleH[e][a]), l.push(o.globals.seriesCandleL[e][a]), l.push(o.globals.seriesCandleC[e][a])),
                        "rangeBar" === o.config.chart.type && (l.pop(), l.push(o.globals.seriesRangeStart[e][a]), l.push(o.globals.seriesRangeEnd[e][a])),
          ...
          value: function () {
            ...
            return (
              !t.globals.isBarHorizontal || this.isTimelineBar
                ? ((i = this.xaxisLabels.length), this.isTimelineBar && (a = t.globals.labels.length), this._drawXYLines({ xCount: i, tickAmount: a }))
            ...
            for (var d = t; d < a; d++) {
              ...
              for (var u = 0; u < r.series[d].length; u++) {
                ...
                null !== f && g.isNumber(f)
                  ...
                  ((n = Math.max(n, r.seriesCandleO[d][u])), (n = Math.max(n, r.seriesCandleH[d][u])), (n = Math.max(n, r.seriesCandleL[d][u])), (i = n = Math.max(n, r.seriesCandleC[d][u]))),
                  g.isFloat(f) && ((f = g.noExponents(f)), (r.yValueDecimal = Math.max(r.yValueDecimal, f.toString().split(".")[1].length))),
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (
              (null === i && (i = this.isBarDistributed || ("heatmap" === a.config.chart.type && a.config.plotOptions.heatmap.colorScale.inverse)), i && (s = a.globals.series[0].length * a.globals.series.length), t.length < s)
            )
        ...
        },
        {
          ...
          value: function (t) {
            var e = this.w,
              ...
              r = "middle";
            if (
              ("left" === i.align ? ((a = 10), (r = "start")) : "right" === i.align && ((a = e.globals.svgWidth - 10), (r = "end")), (a += i.offsetX), (s = s + parseInt(i.style.fontSize, 10) + i.margin / 2), void 0 !== i.text)
            ) {
              var n = new p(this.ctx).drawText({ x: a, y: s, text: i.text, textAnchor: r, fontSize: i.style.fontSize, fontFamily: i.style.fontFamily, fontWeight: i.style.fontWeight, foreColor: i.style.color, opacity: 1 });
          ...
          value: function () {
            ...
            for (var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0; n ? o >= 0 : o <= i.length - 1; n ? o-- : o++) {
              ...
              L || (L = t.config.chart.foreColor),
                ...
                p.setAttrs(C, { rel: o + 1, i: o, "data:default-text": encodeURIComponent(l), "data:collapsed": h || c }),
                S.appendChild(u),
                S.appendChild(C);
              ...
              (P.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && S.classList.add("apexcharts-hidden-null-series")),
          ...
          value: function (t) {
            ...
            for (var i = 0; i < e.length; i++)
              this.elMenuItems.push(document.createElement("div")),
                ...
                p.setAttrs(this.elMenuItems[i], { class: "apexcharts-menu-item ".concat(e[i].name), title: e[i].title }),
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            h && !r.config.xaxis.convertedCatToNumeric && ((u = Math.ceil(c / o)), (u -= 1));
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            h.showTooltipTitle && (null === h.tooltipTitle && (h.tooltipTitle = l.globals.dom.baseEl.querySelector(".apexcharts-tooltip-title")), (h.tooltipTitle.innerHTML = d)),
            ...
            (l.config.tooltip.marker.fillColors && Array.isArray(l.config.tooltip.marker.fillColors) && (o = l.config.tooltip.marker.fillColors[e]), (f[0].style.backgroundColor = o)),
            l.config.tooltip.marker.show || (f[0].style.display = "none"),
            null !== u) && ((a[i].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = l.config.tooltip.z.title), (a[i].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = void 0 !== u ? u : ""));
          ...
          value: function (t) {
            ...
            if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area") || d.contains("apexcharts-rangebar-area")) {
              ...
              a.globals.comboCharts && (n = parseInt(g.parentNode.getAttribute("data:realIndex"), 10)),
                r.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: n, j: s, y1: y ? parseInt(y, 10) : null, y2: w ? parseInt(w, 10) : null, shared: !r.showOnIntersect && a.config.tooltip.shared }),
            ...
            if (
              ...
              (s
                ...
                : a
                  ...
                  : "heatmap" === e && (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap")),
              o && o.length)
            )
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              var i = this,
                a = this.w;
              (this.graphics = new p(this.ctx)), (this.bar = new X(this.ctx, this.xyRatios));
              ...
              for (
                var o = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }),
                  ...
                  c = function (s, r) {
                    ...
                    var m = i.graphics.group({ class: "apexcharts-series", seriesName: g.escapeString(a.globals.seriesNames[b]), rel: s + 1, "data:realIndex": b });
                    ...
                    for (var A = 0; A < a.globals.dataPoints; A++) {
                      var S = i.barHelpers.getStrokeWidth(s, A, b),
                        ...
                        L = null;
                      i.isHorizontal
                        ? ((L = i.drawStackedBarPaths(n({}, C, { zeroW: f, barHeight: y, yDivision: d }))), (w = i.series[s][A] / i.invertedYRatio))
                        : ((L = i.drawStackedColumnPaths(n({}, C, { xDivision: c, barWidth: w, zeroH: u }))), (y = i.series[s][A] / i.yRatio[i.yaxisIndex])),
                        (h = L.y),
                        (l = L.x),
                        p.push(l),
                        x.push(h);
            ...
            value: function (t) {
              ...
              if (g > 0) {
                ...
                this.prevXVal[g - 1][u] < 0
                  ? (b = this.series[g][u] >= 0 ? this.prevX[g - 1][u] + p - 2 * (this.isReversed ? p : 0) : this.prevX[g - 1][u])
                  : this.prevXVal[g - 1][u] >= 0 && (b = this.series[g][u] >= 0 ? this.prevX[g - 1][u] : this.prevX[g - 1][u] - p + 2 * (this.isReversed ? p : 0)),
                  (e = b);
              } else e = r;
              ...
              var m = this.barHelpers.getBarpaths({ barYPosition: d, barHeight: a, x1: e, x2: n, strokeWidth: s, series: this.series, realIndex: i.realIndex, i: g, j: u, w: c });
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
              var c = i.group({ class: "apexcharts-series apexcharts-heatmap-series", seriesName: g.escapeString(e.globals.seriesNames[h]), rel: h + 1, "data:realIndex": h });
              ...
              for (var f = 0, x = 0; x < l[h].length; x++) {
                ...
                if (
                  (A.attr({ cx: f, cy: n }),
                    ...
                    c.add(A),
                    A.attr({ fill: y, i: h, index: h, j: x, val: l[h][x], "stroke-width": this.strokeWidth, stroke: e.config.plotOptions.heatmap.useFillColorAsStroke ? y : e.globals.stroke.colors[0], color: y }),
                ...
                var T = this.calculateHeatmapDataLabels({ x: f, y: n, i: h, j: x, heatColorProps: v, series: l, rectHeight: r, rectWidth: s });
                null !== T && c.add(T), (f += s);
              }
              (n += r), a.add(c);
            }
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (var f = 0; f < t.length; f++) {
              var x = s.group({ class: "apexcharts-series apexcharts-pie-series", seriesName: g.escapeString(i.globals.seriesNames[f]), rel: f + 1, "data:realIndex": f });
              n.add(x), (h = d), (c = (l = c) + t[f]), (d = h + this.prevSectorAngleArr[f]);
              var b = c < l ? this.fullAngle + c - l : c - l,
                m = r.fillPath({ seriesNumber: f, size: this.sliceSizes[f], value: e[f] }),
                v = this.getChangedPath(h, d),
                y = s.drawPath({
                  d: v,
                  stroke: this.lineColorArr instanceof Array ? this.lineColorArr[f] : this.lineColorArr,
                  strokeWidth: 0,
                  fill: m,
                  fillOpacity: i.config.fill.opacity,
                  classes: "apexcharts-pie-area apexcharts-".concat(this.chartType.toLowerCase(), "-slice-").concat(f),
                });
              if ((y.attr({ index: 0, j: f }), i.config.chart.dropShadow.enabled)) {
                var w = i.config.chart.dropShadow;
                a.dropShadow(y, w, f);
              }
              this.addListeners(y, this.donutDataLabels), p.setAttrs(y.node, { "data:angle": b, "data:startAngle": l, "data:strokeWidth": this.strokeWidth, "data:value": e[f] });
              var k = { x: 0, y: 0 };
              "pie" === this.chartType || "polarArea" === this.chartType
                ? (k = g.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (l + b / 2) % this.fullAngle))
                : "donut" === this.chartType && (k = g.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (l + b / 2) % this.fullAngle)),
                x.add(y);
              var A = 0;
              if (
                (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                  ? this.animBeginArr.push(0)
                  : (0 === (A = (b / this.fullAngle) * i.config.chart.animations.speed) && (A = 1), (this.animDur = A + this.animDur), this.animBeginArr.push(this.animDur)),
                  this.dynamicAnim && i.globals.dataChanged
                    ...
                    : this.animatePaths(y, { size: this.sliceSizes[f], endAngle: c, startAngle: l, i: f, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: A }),
                i.config.plotOptions.pie.expandOnClick && "polarArea" !== this.chartType && y.click(this.pieClicked.bind(this, f)),
                  i.config.dataLabels.enabled)
              ) {
                var S = k.x,
                  C = k.y,
                  P = (100 * b) / this.fullAngle + "%";
                if (0 !== b && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[f]) {
                  var T = i.config.dataLabels.formatter;
                  void 0 !== T && (P = T(i.globals.seriesPercent[f][0], { seriesIndex: f, w: i }));
                  var z = i.globals.dataLabels.style.colors[f],
                    I = s.drawText({
                      x: S,
                      y: C,
                      text: P,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return "donut" === e.chartType
              ? [].concat(b, ["L", f.x, f.y, "A", e.donutSize, e.donutSize, 0, x, 0, p.x, p.y, "L", h, c, "z"]).join(" ")
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (
              (r
                ? ((n = t.total.color), (c = t.total.fontSize), (d = t.total.fontFamily), (g = t.total.fontWeight), (x = t.total.label), (f = t.total.formatter(i)))
                : 1 === i.globals.series.length && ((f = u(i.globals.series[0], i)), (x = i.globals.seriesNames[0])),
              x && (x = t.name.formatter(x, t.total.show, i)),
                t.name.show)
            ) {
              var b = a.drawText({ x: l, y: h + parseFloat(t.name.offsetY), text: x, textAnchor: "middle", foreColor: n, fontSize: c, fontWeight: g, fontFamily: d });
                ...
                t.forEach(function (t, o) {
                  ...
                  for (var m = 0; m < c.linePathsTo.length; m++) {
                    var v = e.graphics.renderPaths(
                      n({}, d, { pathFrom: null === b ? c.linePathsFrom[m] : b, pathTo: c.linePathsTo[m], strokeWidth: Array.isArray(e.strokeWidth) ? e.strokeWidth[o] : e.strokeWidth, fill: "none", drawShadow: !1 })
                    );
                    h.add(v);
                    var y = a.fillPath({ seriesNumber: o }),
                      w = e.graphics.renderPaths(n({}, d, { pathFrom: null === b ? c.areaPathsFrom[m] : b, pathTo: c.areaPathsTo[m], strokeWidth: 0, fill: y, drawShadow: !1 }));
                  ...
                  t.forEach(function (t, a) {
                    ...
                    if (d.enabled) {
                      ...
                      r.plotDataLabelsText({ x: f[a].x, y: f[a].y, text: g, textAnchor: "middle", i: o, j: o, parent: x, offsetCorrection: !1, dataLabelsConfig: n({}, d) });
                    }
                    h.add(x);
                  }),
                    s.push(h);
        ...
        a(i, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var o = 0; o < t.series.length; o++) {
                ...
                var f = i.drawPath({ d: "", stroke: c, strokeWidth: (n * parseInt(h.strokeWidth, 10)) / 100, fill: "none", strokeOpacity: h.opacity, classes: "apexcharts-radialbar-area" });
                ...
                l.add(f),
                  ...
                  this.animatePaths(f, { centerX: t.centerX, centerY: t.centerY, endAngle: g, startAngle: d, size: t.size, i: o, totalItems: 2, animBeginArr: 0, dur: 0, isTrack: !0, easing: e.globals.easing });
              }
              return a;
            },
          },
          {
            ...
            value: function (t) {
              ...
              var x = null;
              this.radialDataLabels.show && (x = this.renderInnerDataLabels(this.radialDataLabels, { hollowSize: l, centerX: t.centerX, centerY: t.centerY, opacity: f })),
              ...
              for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                var v = i.group({ class: "apexcharts-series apexcharts-radial-series", seriesName: g.escapeString(e.globals.seriesNames[m]) });
                ...
                var y = a.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                  ...
                  C = void 0;
                e.globals.dataChanged && ((k = this.startAngle), (C = Math.round((this.totalAngle * g.negToZero(e.globals.previousPaths[m])) / 100) + k)),
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            this.zeroY > a.globals.gridHeight && (this.areaBottomY = a.globals.gridHeight),
              ...
              (this.elSeries = s.group({ class: "apexcharts-series", seriesName: g.escapeString(a.globals.seriesNames[i]) })),
          ...
          value: function (t) {
            ...
            if ("area" === e)
              for (var c = l.fillPath({ seriesNumber: i }), d = 0; d < s.areaPaths.length; d++) {
                var g = o.renderPaths(n({}, h, { pathFrom: s.pathFromArea, pathTo: s.areaPaths[d], stroke: "none", strokeWidth: 0, strokeLineCap: null, fill: c }));
                this.elSeries.add(g);
              }
            if (r.config.stroke.show && !this.pointsChart) {
              ...
              for (var f = 0; f < s.linePaths.length; f++) {
                var x = o.renderPaths(n({}, h, { pathFrom: s.pathFromLine, pathTo: s.linePaths[f], stroke: u, strokeWidth: this.strokeWidth, strokeLineCap: r.config.stroke.lineCap, fill: "none" }));
                this.elSeries.add(x);
              }
            }
          },
          ...
          value: function (t) {
            ...
            if ((Array.isArray(f.config.stroke.curve) && (b = Array.isArray(u) ? f.config.stroke.curve[u[i]] : f.config.stroke.curve[i]), "smooth" === b)) {
              ...
              f.globals.hasNullValues
                ? (null !== e[i][s] &&
                (null !== e[i][s + 1]
                  ? ((h = x.move(o, l) + x.curve(o + v, l, r - v, n, r + 1, n)), (c = x.move(o + 1, l) + x.curve(o + v, l, r - v, n, r + 1, n) + x.line(r, m) + x.line(o, m) + "z"))
                ...
                (o = r),
                (l = n),
              s === e[i].length - 2 && ((c = c + x.curve(o, l, r, n, r, m) + x.move(r, n) + "z"), f.globals.hasNullValues || (d.push(h), g.push(c)));
            } else {
              if (null === e[i][s + 1]) {
                h += x.move(r, n);
              ...
              null === e[i][s] && ((h += x.move(r, n)), (c += x.move(r, m))),
                "stepline" === b ? ((h = h + x.line(r, null, "H") + x.line(null, n, "V")), (c = c + x.line(r, null, "H") + x.line(null, n, "V"))) : "straight" === b && ((h += x.line(r, n)), (c += x.line(r, n))),
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.firstVal,
              ...
              u = l,
              f = c(h, i, a);
            0 === e.minHour && 1 === e.minDate && ((d = 0), (u = g.monthMod(e.minMonth)), (o = "month"), (h = e.minDate), r++),
              this.timeScaleArray.push({ position: d, value: u, unit: o, year: this._getYear(a, f, 0), month: g.monthMod(f), day: h });
        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (var b = h, m = 0; m < l; m++)
              d >= 60 && ((d = 0), 24 === (x += 1) && (x = 0)),
                (b = o + b),
                this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: x, minute: d, day: u, year: this._getYear(n, f, 0), month: g.monthMod(f) }),
                d++;
          },
        },
        {
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            if (
              ("%" === a
                ? g.isNumber(i[0]) && (0 === i[0].width && (i = g.getDimensions(this.el.parentNode)), (t.svgWidth = (i[0] * parseInt(e.chart.width, 10)) / 100))
                ...
                (e.config.chart.events.selection = function (t, a) {
                  i.forEach(function (t) {
                    ...
                    var o = i.w.config.yaxis.reduce(function (t, e, a) {
                      return [].concat(d(t), [n({}, i.w.config.yaxis[a], { min: s[0].min, max: s[0].max })]);
                    }, []);
            ...
            this.ctx.w.globals.isExecCalled && ((o = [this.ctx]), (this.ctx.w.globals.isExecCalled = !1)),
              o.forEach(function (r) {
                ...
                return (
                  ...
                  n && ((o.globals.lastXAxis = []), (o.globals.lastYAxis = []), (o.globals.initialConfig = g.extend({}, o.config)), (o.globals.initialSeries = JSON.parse(JSON.stringify(o.config.series))))),
                    r.update(e)
                );
              });
          },
          ...
          value: function (t, e) {
            ...
            return (
              i.globals.axisCharts
                ...
                a ? (new p(this.ctx).pathMouseDown(a, null), a.node ? a.node : null) : (console.warn("toggleDataPointSelection: Element not found"), null)
            );
          },
        },
        {
          ...
          value: function () {
            ...
            (e.config.xaxis.min = e.globals.lastXAxis.min),
              ...
              e.config.yaxis.map(function (i, a) {
                e.globals.zoomed
                  ? void 0 !== e.globals.lastYAxis[a] && ((i.min = e.globals.lastYAxis[a].min), (i.max = e.globals.lastYAxis[a].max))
                  : void 0 !== t.ctx.opts.yaxis[a] && ((i.min = t.ctx.opts.yaxis[a].min), (i.max = t.ctx.opts.yaxis[a].max));
              });
          },
        },
      ]),
