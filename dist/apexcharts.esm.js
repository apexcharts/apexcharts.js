  ...
  _createClass(DataLabels, [{
    ...
    value: function plotDataLabelsText(opts) {
      ...
      var x = opts.x,
          ...
          filledBubbles = opts.filledBubbles;
      ...
      for (var i = rev ? 0 : heatSeries.length - 1; rev ? i < heatSeries.length : i >= 0; rev ? i++ : i--) {
        ...
        for (var j = 0; j < heatSeries[i].length; j++) {
          ...
          if (w.config.plotOptions.heatmap.enableShades) {
            ...
            color = "rgba(".concat(heatColorProps.color.r, ", ").concat(heatColorProps.color.g, ", ").concat(heatColorProps.color.b, ", ").concat(1 - colorShadePercent, ")");
          }
          ...
          elSeries.add(rect);
          rect.attr({
            fill: w.config.plotOptions.heatmap.filledBubbles ? color : 'transparent',
            i: i,
            index: i,
            j: j,
            val: heatSeries[i][j],
            'stroke-width': this.strokeWidth,
            stroke: w.config.plotOptions.heatmap.filledBubbles ? w.globals.stroke.colors[0] : '#353942',
            color: color
          });
