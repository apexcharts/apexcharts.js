...
var Filters = function () {
  ...
  _createClass(Filters, [{
    ...
    value: function dropShadow(el, attrs) {
      ...
      el.filter(function (add) {
        var shadowBlur = null;
        if (_Utils2.default.isSafari || _Utils2.default.isFirefox) {
...
var _DataLabels = __webpack_require__(44);
  ...
  _createClass(Bar, [{
    ...
    value: function calculateBarDataLabels(_ref3) {
      ...
      if (this.isHorizontal) {
        ...
        var valIsNegative = !!(x + 0.15 < emptySpaceBackwards && Math.abs(this.baseLineInvertedY) !== 0);
...
var _Scatter = __webpack_require__(72);
...
var _Defaults = __webpack_require__(136);
...
var _TimeScale = __webpack_require__(74);
...
var _Markers = __webpack_require__(45);
...
var _Dimensions = __webpack_require__(29);
...
var _Annotations = __webpack_require__(123);
...
var _Core = __webpack_require__(125);

var _Core2 = _interopRequireDefault(_Core);

var _Crosshairs = __webpack_require__(73);
...
var _Legend = __webpack_require__(127);
...
var _ZoomPanSelection = __webpack_require__(134);

var _ZoomPanSelection2 = _interopRequireDefault(_ZoomPanSelection);

var _Scroller = __webpack_require__(130);
...
var _SubTitle = __webpack_require__(131);
...
$export($export.P + $export.F * !__webpack_require__(102)([].reduce, true), 'Array', {
...
var _Bar2 = __webpack_require__(43);
  ...
  _createClass(CandleStick, [{
    ...
    value: function draw(series, seriesIndex) {
      ...
      var _loop = function _loop(i, bc) {
        ...
        if (series[i].length > 0) {
          _this2.visibleI = _this2.visibleI + 1;
        }
        ...
        var initPositions = _this2.initialPositions();
        ...
        var _loop2 = function _loop2(j, tj) {
          if (typeof _this2.series[i][j] === 'undefined' || series[i][j] === null) {
            _this2.isNullValue = true;
          } else {
            _this2.isNullValue = false;
          }
          if (w.config.stroke.show) {
          ...
          var seriesNumber = _this2.barOptions.distributed ? j : i;
          ...
          var dataLabels = _this2.calculateBarDataLabels({ x: x, y: y, i: i, j: j, series: series, realIndex: realIndex, barHeight: barHeight, barWidth: barWidth, renderedPath: renderedPath, visibleSeries: _this2.visibleI });
...
var _Pie2 = __webpack_require__(71);
...
var _Bar = __webpack_require__(43);

var _Bar2 = _interopRequireDefault(_Bar);

var _BarStacked = __webpack_require__(118);

var _BarStacked2 = _interopRequireDefault(_BarStacked);

var _CandleStick = __webpack_require__(119);
...
var _HeatMap = __webpack_require__(120);

var _HeatMap2 = _interopRequireDefault(_HeatMap);

var _Pie = __webpack_require__(71);
...
var _XAxis = __webpack_require__(46);
...
var _ClassListPolyfill = __webpack_require__(150);
...
var _svg = __webpack_require__(146);
...
var Core = function () {
  ...
  _createClass(Core, [{
    ...
    value: function setupElements() {
      ...
      var axisChartsArryTypes = ['line', 'bar', 'area', 'scatter', 'bubble', 'heatmap', 'candlestick'];
...
var _Toolbar2 = __webpack_require__(75);
...
var _Labels = __webpack_require__(140);
...
var _Marker = __webpack_require__(141);

var _Marker2 = _interopRequireDefault(_Marker);

var _Intersect = __webpack_require__(139);

var _Intersect2 = _interopRequireDefault(_Intersect);

var _AxesTooltip = __webpack_require__(138);
