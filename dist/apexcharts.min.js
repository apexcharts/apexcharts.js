...
var CandleStick = function (_Bar) {
  ...
  _createClass(CandleStick, [{
    ...
    value: function drawCandleStickPaths(_ref) {
      ...
      var isPositive = true;
      var colorPos = w.config.plotOptions.candlestick.colors.positive;
      var colorNeg = w.config.plotOptions.candlestick.colors.negative;
      ...
      pathTo = graphics.move(barXPosition, y2) + graphics.line(barXPosition + barWidth / 2, y2) + graphics.line(barXPosition + barWidth / 2, l1) + graphics.line(barXPosition + barWidth / 2, y2) + graphics.line(barXPosition + barWidth, y2) + graphics.line(barXPosition + barWidth, y1) + graphics.line(barXPosition + barWidth / 2, y1) + graphics.line(barXPosition + barWidth / 2, l2) + graphics.line(barXPosition + barWidth / 2, y1) + graphics.line(barXPosition, y1) + graphics.line(barXPosition, y2);

      pathFrom = pathFrom + graphics.line(barXPosition, zeroH);
