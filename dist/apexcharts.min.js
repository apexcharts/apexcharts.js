...
var _Annotations = __webpack_require__(102);
...
var _Crosshairs = __webpack_require__(105);
...
var _ZoomPanSelection = __webpack_require__(118);

var _ZoomPanSelection2 = _interopRequireDefault(_ZoomPanSelection);

var _Scroller = __webpack_require__(109);
...
var ApexCharts = function () {
  function ApexCharts(el, opts) {
    ...
    this.w = new _Base2.default(this.opts).init();
    this.ctx = this;

    this.el = el;
    this.core = new _Core2.default(el, this.ctx);
  ...
  _createClass(ApexCharts, [{
    ...
    value: function create(ser) {
      ...
      if (w.config.chart.type === 'heatmap') {
        ...
        //  get the longest string from the labels array and also apply label formatter to it
        var longest = gl.seriesNames.reduce(function (a, b) {
          return a.length > b.length ? a : b;
        });
    ...
    value: function mount() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var drawAnnotations = function drawAnnotations() {
          if (me.w.globals.axisCharts) {
            var annotations = new _Annotations2.default(me.ctx);
            var yAnnotations = annotations.drawYAxisAnnotations();
            var xAnnotations = annotations.drawXAxisAnnotations();
            var pointAnnotations = annotations.drawPointAnnotations();
        ...
        if (w.config.yaxis[0].crosshairs.position === 'front') {
          var _crosshairs2 = new _Crosshairs2.default(me.ctx);
          _crosshairs2.drawYCrosshairs();
        }
    ...
    value: function addXaxisAnnotation(opts) {
      ...
      var xAxisAnno = Object.assign({}, _Options.xAxisAnnotation);
      var anno = _Utils2.default.extend(xAxisAnno, opts);
      ...
      var elRect = annotations.addBackgroundToAnno(xAnnoLabel, anno, index);
    ...
    value: function addYaxisAnnotation(opts) {
      ...
      var yAxisAnno = Object.assign({}, _Options.yAxisAnnotation);
      var anno = _Utils2.default.extend(yAxisAnno, opts);
      ...
      var elRect = annotations.addBackgroundToAnno(yAnnoLabel, anno, index);
    ...
    value: function addPointAnnotation(opts) {
      ...
      var pointAnno = Object.assign({}, _Options.pointAnnotation);
      var anno = _Utils2.default.extend(pointAnno, opts);
      ...
      var elRect = annotations.addBackgroundToAnno(pointLabel, anno, index);
    ...
    value: function addText(_ref) {
      var x = _ref.x,
          ...
          appendTo = _ref$appendTo === undefined ? '.apexcharts-inner' : _ref$appendTo,
          ...
          paddingLeft = _ref$paddingLeft === undefined ? 4 : _ref$paddingLeft,
          _ref$paddingRight = _ref.paddingRight,
          paddingRight = _ref$paddingRight === undefined ? 4 : _ref$paddingRight,
          _ref$paddingBottom = _ref.paddingBottom,
          paddingBottom = _ref$paddingBottom === undefined ? 2 : _ref$paddingBottom,
          _ref$paddingTop = _ref.paddingTop,
          paddingTop = _ref$paddingTop === undefined ? 2 : _ref$paddingTop;
      var pushToMemory = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var context = arguments[2];
...
var _Bar2 = __webpack_require__(52);
...
var _Pie2 = __webpack_require__(53);
  ...
  _createClass(Radial, [{
    ...
    value: function dataLabelsMouseIn(el) {
      ...
      if (w.config.plotOptions.radialBar.dataLabels.name.color === undefined) {
        labelColor = w.config.colors[parseInt(el.parentNode.getAttribute('rel')) - 1];
      } else {
  ...
  _createClass(Annotations, [{
    ...
    value: function annotationsBackground() {
      ...
      w.config.annotations.xaxis.map(function (anno, i) {
        ...
        var elRect = _this4.addBackgroundToAnno(xAnnoLabel, anno, i);
      ...
      w.config.annotations.yaxis.map(function (anno, i) {
        ...
        var elRect = _this4.addBackgroundToAnno(yAnnoLabel, anno, i);
      ...
      w.config.annotations.points.map(function (anno, i) {
        ...
        var elRect = _this4.addBackgroundToAnno(pointAnnoLabel, anno, i);
...
var _Bar = __webpack_require__(52);

var _Bar2 = _interopRequireDefault(_Bar);

var _BarStacked = __webpack_require__(98);

var _BarStacked2 = _interopRequireDefault(_BarStacked);

var _HeatMap = __webpack_require__(99);

var _HeatMap2 = _interopRequireDefault(_HeatMap);

var _Pie = __webpack_require__(53);

var _Pie2 = _interopRequireDefault(_Pie);

var _Radial = __webpack_require__(101);
...
var _svg = __webpack_require__(62);
...
var Core = function () {
  ...
  _createClass(Core, [{
    ...
    key: 'setSparkLineOptions',
    value: function setSparkLineOptions() {
      var w = this.w;
      var cnf = w.config;
      ...
      if (w.config.chart.sparkline.enabled) {
        ...
        try {
          for (var _iterator = cnf.yaxis[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var yaxe = _step.value;
    ...
    value: function parseData(ser) {
      ...
      if (gl.axisCharts) {
          ...
          if (isMultiFormat()) {
            if (isFormat2DArray()) {
              ...
              for (var _j = 0; _j < ser[i].data.length; _j++) {
                if (typeof ser[i].data[_j][2] !== 'undefined') {
                  threeDSeries.push(ser[i].data[_j][2]);
                  gl.dataXYZ = true;
                }
              }
            } else if (isFormatXY()) {
              for (var _j2 = 0; _j2 < ser[i].data.length; _j2++) {
                if (typeof ser[i].data[_j2].y !== 'undefined') {
                  twoDSeries.push(ser[i].data[_j2].y);
                }

                var isXString = typeof ser[i].data[_j2].x === 'string';
                var isXDate = dt.isValidDate(ser[i].data[_j2].x.toString());

                if (isXString || isXDate) {
                  // user supplied '01/01/2017' or a date string (a JS date object is not supported)
                  if (isXString) {
                    if (cnf.xaxis.type === 'datetime') {
                      twoDseriesX.push(new Date(ser[i].data[_j2].x).getTime());
                    } else {
                      // a category and not a numeric x value
                      fallbackToCategory = true;
                      twoDseriesX.push(ser[i].data[_j2].x);
                    }
                  } else if (isXDate) {
                    if (cnf.xaxis.type === 'datetime') {
                      twoDseriesX.push(new Date(ser[i].data[_j2].x.toString()).getTime());
                    } else {
                      twoDseriesX.push(parseInt(ser[i].data[_j2].x));
                    }
                  } else {
                    fallbackToCategory = true;
                    twoDseriesX.push(parseInt(ser[i].data[_j2].x));
            ...
            if (cnf.xaxis.type === 'datetime') {
              ...
              for (var _j3 = 0; _j3 < dates.length; _j3++) {
                if (typeof dates[_j3] === 'string') {
                  var isDate = dt.isValidDate(dates[_j3]);
                  if (isDate) {
                    twoDseriesX.push(new Date(dates[_j3]).getTime());
                  }
                }
              }
        ...
        for (var _i = 0; _i < gl.series.length; _i++) {
          if (gl.seriesNames[_i] === undefined) {
            gl.seriesNames.push('series-' + (_i + 1));
          }
        }
      }
      ...
      if (cnf.chart.type === 'bar' && cnf.chart.stacked) {
        ...
        gl.series = _series.setNullSeriesToZeroValues(gl.series);
      }
      ...
      if (!gl.dataXY) {
        ...
        if (cnf.xaxis.categories.length > 0) {
          ...
          var labelArr = [];
          if (gl.axisCharts) {
            for (var _i2 = 0; _i2 < gl.series[gl.maxValsInArrayIndex].length; _i2++) {
              labelArr.push(_i2 + 1);
            }
    ...
    value: function getCalculatedRatios() {
      ...
      // multiple y axis
      for (var _i5 = 0; _i5 < gl.yRange.length; _i5++) {
        yRatio.push(gl.yRange[_i5] / gl.gridHeight);
      }
      ...
      if (gl.minY !== Number.MIN_VALUE && Math.abs(gl.minY) !== 0) {
        ...
        if (gl.isMultipleYAxis) {
          for (var _i6 = 0; _i6 < yRatio.length; _i6++) {
            baseLineY.push(-gl.minYArr[_i6] / yRatio[_i6]);
          }
        } else {
    ...
    value: function checkComboCharts() {
      ...
      cnf.series.map(function (series, st) {
...
var Legend = function () {
  ...
  _createClass(Legend, [{
    ...
    value: function drawLegends(type, seriesLength) {
      ...
      var fillcolor = w.config.colors.slice();
    ...
    value: function setLegendWrapXY() {
      ...
      var y = w.config.legend.containerMargin.top - w.config.legend.markers.size - 2;
  ...
  _createClass(Range, [{
    ...
    value: function handleMinYMaxY() {
      ...
      var getMinYMaxY = function getMinYMaxY(startingIndex, len) {
        ...
        for (var i = startingIndex; i < len; i++) {
          ...
          if (_Utils2.default.isIE()) {
            minY = Math.min.apply(Math, _toConsumableArray(gl.series[i]));
          }
      ...
      if (cnf.chart.stacked) {
        ...
        for (var j = 0; j < gl.series[gl.maxValsInArrayIndex].length; j++) {
          ...
          var negs = 0;
          for (var _i = 0; _i < gl.series.length; _i++) {
            if (gl.series[_i][j] !== null && _Utils2.default.isInt(gl.series[_i][j])) {
              if (gl.series[_i][j] > 0) {
      ...
      var reCalculateMinMaxY = function reCalculateMinMaxY(startingIndex, minY, maxY) {
        ...
        if (maxY === -Number.MAX_VALUE) {
          ...
          gl.yAxisScale.push(_this.justRange(0, 2, 2));
        } else {
    ...
    value: function handleMinXMaxX() {
      ...
      if ((gl.comboCharts || cnf.chart.type === 'bar') && (cnf.xaxis.type === 'datetime' || gl.dataXY)) {
        var minX = gl.minX - gl.svgWidth / gl.dataPoints * (Math.abs(gl.maxX - gl.minX) / gl.svgWidth);
        gl.minX = minX;
        gl.initialminX = minX;
        var maxX = gl.maxX + gl.svgWidth / gl.dataPoints * (Math.abs(gl.maxX - gl.minX) / gl.svgWidth);
        gl.maxX = maxX;
        gl.initialmaxX = maxX;
      }
...
var AxesTooltip = function () {
  ...
  _createClass(AxesTooltip, [{
    ...
    value: function drawYaxisTooltipText(index, clientY, seriesBound, xyRatios) {
      ...
      var lbFormatter = w.config.yaxis[index].labels.formatter;
    ...
    value: function handleHeatTooltip(_ref) {
      ...
      if (e.target.classList.contains('apexcharts-heatmap-rect')) {
        ...
        if (ttCtx.w.config.tooltip.followCursor) {
          var elGrid = ttCtx.w.globals.dom.baseEl.querySelector('.apexcharts-grid');
          var seriesBound = elGrid.getBoundingClientRect();
  ...
  _createClass(Labels, [{
    ...
    value: function drawSeriesTexts(_ref) {
      ...
      if (w.globals.dataXY && w.config.xaxis.type === 'datetime') {
        ...
        xVal = w.globals.ttKeyFormatter(bufferXVal, { series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });
      } else {
        xVal = w.globals.xLabelFormatter(bufferXVal, { series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });
      }
      ...
      for (var t = 0, inverset = w.globals.series.length - 1; t < w.globals.series.length; t++, inverset--) {
        var seriesName = w.config.tooltip.y.title.formatter(String(w.globals.seriesNames[i]), { series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });

        if (shared) {
          var tIndex = w.config.tooltip.inverseOrder ? inverset : t;

          seriesName = w.config.tooltip.y.title.formatter(String(w.globals.seriesNames[tIndex]), { series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });
          pColor = w.config.colors[tIndex];
          // for plot charts, not for pie/donuts
          val = yLbFormatter(w.globals.series[tIndex][j], { series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });
        ...
        if (w.config.tooltip.custom !== undefined) {
          ...
          ttCtx.tooltip.innerHTML = w.config.tooltip.custom({ series: w.globals.series, seriesIndex: i, dataPointIndex: j, w: w });
          return;
        }
...
var _Labels = __webpack_require__(115);
...
var _Marker = __webpack_require__(116);

var _Marker2 = _interopRequireDefault(_Marker);

var _Intersect = __webpack_require__(114);

var _Intersect2 = _interopRequireDefault(_Intersect);

var _AxesTooltip = __webpack_require__(113);
      ...
      if (e.type === 'mousemove' || e.type === 'touchmove') {
        ...
        if (isStickyTooltip && !self.showOnIntersect) {
          ...
          if (w.globals.dataXY && capturedSeries !== null) {
            x = (w.globals.seriesX[capturedSeries][j] - w.globals.minX) / self.xyRatios.xRatio;
          }
          if (w.config.tooltip.followCursor) {
          ...
          if (w.config.chart.type === 'heatmap') {
            ...
            if (hasMarkers) {
              ...
              var _markerXY = this.intersect.handleMarkerTooltip({
                e: e,
                opt: opt,
                x: x,
                y: y
...
var _Toolbar2 = __webpack_require__(56);
...
var ZoomPanSelection = function (_Toolbar) {
  ...
  _createClass(ZoomPanSelection, [{
    ...
    value: function init(_ref) {
      ...
      var diffInH = (w.globals.svgHeight - gridRectH) * xyRatios.yRatio[0];
      ...
      try {
        for (var _iterator = eventList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          hoverArea.addEventListener(event, self.svgMouseEvents.bind(self, opts, xyRatios), false);
        }
      } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
    ...
    key: 'svgMouseEvents',
    value: function svgMouseEvents(opt, xyRatios, e) {
      var w = this.w;
      var me = this;
      var zoomtype = w.globals.zoomEnabled ? w.config.chart.zoom.type : w.config.chart.selection.type;

      var isSelectionMouseDown = e.target.classList.contains('apexcharts-selection-rect');
      ...
      var mouseDownOnZoomArea = function mouseDownOnZoomArea() {
      ...
      if (e.type === 'mousedown' && e.which === 1) {
        ...
        if (w.globals.panEnabled) {
          ...
          if (me.clicked && w.globals.zoomEnabled || me.clicked && w.globals.selectionEnabled) {
    ...
    value: function drawSelectionRect(_ref2) {
      var x = _ref2.x,
          ...
          selectionEnabled = _ref2.selectionEnabled;
